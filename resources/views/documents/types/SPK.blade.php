...
<body>
    ...
    <div class="page">
        ...
        {{-- ── Judul ── --}}
        <div class="doc-title">
            <span class="doc-title-text">Surat Pengantar Karyawan</span>
        </div>
        ...
        <p class="body-text">
            Dengan Hormat,<br>
            Melalui surat ini, kami dari Departemen Human Resources Mandiri menyampaikan bahwa karyawan dengan identitas
            sebagai berikut:
        </p>
        ...
        <p class="body-text">
            Demikian surat pengantar ini kami buat dengan sebenar-benarnya. Atas perhatian dan kerja
