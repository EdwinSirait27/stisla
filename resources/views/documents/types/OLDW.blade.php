...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .salary-table { width: 100%; border-collapse: collapse; margin: 6px 0 6px 30px; font-size: 10.5pt; }
        ...
        .bullet-list { margin: 4px 0 8px 30px; font-size: 10.5pt; line-height: 1.8; }
...
<body>
    @php
        ...
        $terbilang = function ($amount) {
            // helper sederhana — bisa diganti library terbilang
            return ''; 
        };
        ...
        $dailyRate   = $salary?->daily_rate ?? 0;
        $totalGross  = $dailyRate;
    @endphp
    ...
    <div class="page">
        ...
        <table class="data-table">
            <tr>
                ...
                <td class="col-label">Departement</td>
                <td class="col-sep">:</td>
                <td>
    ...
    {{ $employee->store->isNotEmpty() 
        ...
        <table class="salary-table">
            <tr>
                <td class="col-label">Upah Harian</td>
                <td class="col-sep">:</td>
                <td>RP. {{ $formatRupiah($dailyRate) }}</td>
            </tr>
            <tr class="salary-total">
                <td class="col-label">Total Gaji Gross</td>
                <td class="col-sep">:</td>
                <td>RP. {{ $formatRupiah($dailyRate) }} x hari kerja</td>
            </tr>
        </table>
        ...
        <table class="data-table">
            ...
            <tr>
                ...
                <td class="col-label">Tanggal Mulai Kerja</td>
                <td class="col-sep">:</td>
                <td><strong>{{ $formatTgl($employee->join_date) }}</strong></td>
            </tr>
            <tr>
                <td class="col-no">13.</td>
                <td class="col-label" colspan="3">Fasilitas lain :</td>
            </tr>
        </table>

        <ul class="bullet-list">
            <li>BPJS TK & BPJS KES sesuai ketentuan Perusahaan</li>
            <li>THR sesuai ketentuan Perusahaan</li>
        </ul>
