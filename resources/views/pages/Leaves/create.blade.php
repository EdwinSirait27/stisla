        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a href="{{ route('pages.Leaves') }}">Leaves</a></div>
                    <div class="breadcrumb-item">Create Leaves</div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0 px-3">
                                    <h6 class="mb-0">{{ __('Create Leaves') }}</h6>
                                </div>
                                <div class="card-body pt-4 p-3">
                                    ...
                                    @endif
                                    <form id="position-create" action="{{ route('Leaves.store') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="form-control-label">
                                                        <i class="fas fa-user"></i> {{ __('Leaves Name') }}
                                                    </label>
                                                    <div>
                                                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" 
                                                            value="{{ old('name') }}" required
                                                            placeholder="Fill Leaves Name">
                                                        @error('name')
                                        ...
                                        <div class="alert alert-secondary mt-4" role="alert">
                                            <span class="text-dark">
                                                ...
                                                - If a Leaves name is already registered, you cannot register it again.
                                        ...
                                        <div class="d-flex justify-content-end mt-4">
                                            <a href="{{ route('pages.Leaves') }}" class="btn btn-secondary">
