                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0 px-3">
                                    <h6 class="mb-0">{{ __('Update Leave') }} {{ $leave->name }}</h6>
                                </div>
                                <div class="card-body pt-4 p-3">
                                    ...
                                    @endif
                                    <form id="position-edit" action="{{ route('Leaves.update', $hashedId) }}" method="POST">
                                        @csrf
                                        @method('PUT')
