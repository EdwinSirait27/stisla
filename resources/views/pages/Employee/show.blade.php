...
@section('main')
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Update Employee {{ $employee->employee->employee_name }}</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a href="{{ route('pages.Employee') }}">Employees</a></div>
                    <div class="breadcrumb-item">Update Employee {{ $employee->employee->employee_name }}</div>
                </div>
            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input
                                                            ...
                                                            placeholder="Insert Company Email" disabled>
                                                        @error('company_email')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
