                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        value="{{ old('conversion_factor', $uom->conversion_factor ?? '') }}"
                                                        type="text" id="conversion_factor" name="conversion_factor"
                                                        value="{{ old('conversion_factor') }}" aria-describedby="info-conversion_factor"
                                                          placeholder="Insert conversion factor" required>
