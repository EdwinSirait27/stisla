    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Update Department {{ $department->department_name }}</h1>
                <div class="section-header-breadcrumb">
                    {{-- <div class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Dashboard</a></div> --}}
                    <div class="breadcrumb-item"><a href="{{ route('pages.Department') }}">Department</a></div>
                    <div class="breadcrumb-item">Update Department {{ $department->department_name }}</div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body pt-4 p-3">
                                    ...
                                    <form id="departments-edit" action="{{ route('Department.update', $hashedId) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
     ...
     <div>
                                        ...
                                        <div class="alert alert-secondary mt-4" role="alert">
                                            <span class="text-dark">
                                                ...
                                                - If a Department name is already registered, you cannot register it
                                                again.<br>
