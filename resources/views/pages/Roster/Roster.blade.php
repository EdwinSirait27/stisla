                ...
                <div class="card-body p-0">
                    ...
                    <td class="day-cell {{ $cell['is_weekend'] ? 'weekend' : '' }} {{ $cell['is_today'] ? 'today' : '' }}"
                        ...
                        <span class="{{ $cell['badge_class'] }}">
                            ...
                            @if ($cell['notes'])<span class="r-notes">{{ $cell['notes'] }}</span>@endif
                        </span>
                        @endif
                    </td>
                    @endforeach
...
<div class="m-overlay" id="modalCell">
    <div class="m-box">
        ...
        <div class="m-body">
            ...
            <div id="sickWrap" style="display:none">
             ...
             <div id="mSickExisting" style="font-size:11px;color:#16a34a;margin-top:-8px;margin-bottom:10px;display:none">
    ...
    <small id="mPhCarryoverNote" style="display:none;color:#0f766e;font-size:11px;margin-top:-8px;margin-bottom:10px;"></small>
</div>
...
<div class="m-overlay" id="modalImport">
    <div class="m-box" style="width:460px">
        ...
        <div class="m-body">
            <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:6px;padding:10px 12px;font-size:12px;color:#1e40af;margin-bottom:14px;line-height:1.6">
                <i class="fas fa-info-circle"></i>
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                if (data.errors && data.errors.length) {
                    html += `<div style="margin-top:8px;color:#92400e;"><strong>Baris dilewati:</strong><ul style="margin:4px 0 0 16px;padding:0;">`;
