                ...
                <div class="filter-card">
                    <form method="GET" action="{{ route('roster.index') }}" class="d-flex flex-wrap align-items-end"
                        ...
                        <div class="filter-item-date">
                            ...
                            <input type="date" id="start_date" name="start_date" class="f-control"
                                value="{{ $startDate }}">
                        </div>
                        <div class="filter-item-date">
                            <label class="f-label">End Date</label>
                            <input type="date" id="end_date" name="end_date" class="f-control"
                                value="{{ $endDate }}">
                        </div>
                                        ...
                                        @forelse($employees as $employee)
                                            @php
                                                $rosterByDate = $employee->rosters->keyBy(
                                                    fn($r) => \Carbon\Carbon::parse($r->date)->toDateString(),
                                                );
                                            @endphp
                                            <tr>
                                                <td class="col-emp">
                                                    <div class="emp-name">Employee Name : {{ $employee->employee_name }}
                                                    </div>
                                                    ...
                                                    @php
                                                        ...
                                                        if ($roster) {
                                                            if ($roster->day_type === 'Off') {
                                                                ...
                                                                $badgeTime =
                                                                    substr($roster->shift->start_time, 0, 5) .
                                                                    '-' .
                                                    ...
                                                    <td class="day-cell {{ $isWeekend ? 'weekend' : '' }} {{ $isToday ? 'today' : '' }}"
                                                        ...
                                                        @else
                                                            <span class="{{ $badgeClass }}">
                                                                ...
                                                                @if ($badgeTime)
                                                                    <span class="r-time">{{ $badgeTime }}</span>
                                                                @endif
    ...
    <div class="m-overlay" id="modalBulkDelete">
        <div class="m-box" style="width:400px">
            ...
            <div class="m-body">
                ...
                <small class="text-muted d-block mb-3">Please hold button <kbd>Ctrl</kbd> to choose more than 1
                    employee</small>
        ...
        <div class="m-box" style="width:440px">
            ...
            <div class="m-body">
                ...
                <div
                    ...
                    <i class="fas fa-info-circle"></i>
                    Pola jadwal: <strong>Senin-Jumat</strong> (9 to 5), <strong>Sabtu</strong> (9 to 3),
                    <strong>Minggu</strong> (Off).
...
flatpickr("#start_date", {
    ...
    <script>
        ...
        function saveBulk() {
            ...
            if (!selected.length) {
                toast('⚠️ Choose at least 1 employee.', false);
                return;
            }
        ...
        function saveBulkDelete() {
            ...
            if (!selected.length) {
                toast('Select at least 1 employee.', false);
                return;
            }
