...
@extends('layouts.app')
@section('title', 'Import Fingerspot')
@push('styles')
...
@endif
            ...
            <div class="section-body">
                <div class="form-container">
                    <h2>Import Fingerspot</h2>
                    <form id="import-create" action="{{ route('Importfingerspot.fingerspot') }}" method="POST"
...
<ul>
    @forelse($files as $file)
        <li>
            {{ basename($file) }} -
            <a href="{{ route('Fingerspot.downloadfingerspot', ['filename' => basename($file)]) }}">
                Download
            </a>
        </li>
    @empty
