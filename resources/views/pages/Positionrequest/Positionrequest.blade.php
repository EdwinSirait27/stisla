@extends('layouts.app')
@section('title', 'Position Request')
@push('styles')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h6><i class="fas fa-user-shield"></i> List Position Request By {{$user->employee->employee_name}} </h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-hover" id="users-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">HRD Verifier</th>
                                                <th class="text-center">DIR Verifier</th>
                                ...
                                <div class="action-buttons">
                                    <button type="button" onclick="window.location='{{ route('Positionrequest.create') }}'"
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            var table = $('#users-table').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('positionrequests.positionrequests') }}',
                    type: 'GET'
                },
                responsive: true,
                lengthMenu: [
