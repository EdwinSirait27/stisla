@extends('layouts.app')
@section('title', 'Create Status Product')
@push('style')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Create Status Product</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a href="{{ route('pages.Statusproduct') }}">Tax Status</a></div>
                    <div class="breadcrumb-item">Create Status Product</div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0 px-3">
                                    <h6 class="mb-0">{{ __('Create Status Product') }}</h6>
                                </div>
                                <div class="card-body pt-4 p-3">
                                    ...
                                    <form id="status-create" action="{{ route('Statusproduct.store') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                        ...
                                        <div class="alert alert-secondary mt-4" role="alert">
                                            <span class="text-dark">
                                                ...
                                                - If a status product is already registered, you cannot register it again.<br>
                                            </span>
                                        </div>
