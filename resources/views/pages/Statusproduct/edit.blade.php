@extends('layouts.app')
@section('title', 'Update Status Product')
@push('style')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Update Status Product {{ $status->status }}</h1>
                <div class="section-header-breadcrumb">
                    {{-- <div class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Dashboard</a></div> --}}
                    <div class="breadcrumb-item"><a href="{{ route('pages.Statusproduct') }}">Tax Status</a></div>
                    <div class="breadcrumb-item">Update Status Product {{ $status->status}}</div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0 px-3">
                                    <h6 class="mb-0">{{ __('Update Status Product') }} {{ $status->status }}</h6>
                                </div>
