                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h6><i class="fas fa-user-shield"></i> List Status Product</h6>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="action-buttons">
                                    <button type="button" onclick="window.location='{{ route('Statusproduct.create') }}'"
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            var table = $('#users-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('statusproduct.statusproduct') }}',
                    type: 'GET'
                },
                responsive: true,
                lengthMenu: [
