...
{{-- @section('main')
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body pt-4 p-3">
                                    ...
                                    @endif
                                    <form id="departments-create" action="{{ route('Structuresnew.store') }}"
                                        method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="parant_id" class="form-control-label">
                                                        <i class="fas fa-id-card"></i> {{ __('Hierarky') }}
                                                    </label>
                                        
                                                        <select name="parent_id"
                                                            class="form-control select2 @error('parent_id') is-invalid @enderror">
                                                            <option value="">Choose Hierarky</option>
                                                            @foreach ($parents as $key => $value)
                                                                <option value="{{ $key }}"
                                                                    {{ old('parent_id') == $key ? 'selected' : '' }}>
                                                                    {{ $value }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('parent_id')
    ...
    class="form-control select2 @error('salary_id') is-invalid @enderror"
    required>
