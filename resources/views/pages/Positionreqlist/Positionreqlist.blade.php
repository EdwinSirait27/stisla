@extends('layouts.app')
@section('title', 'Position Request List')
@push('styles')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h6><i class="fas fa-user-shield"></i> Position Request List </h6>
                            </div>
                            <div class="card-body">
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            var table = $('#users-table').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('positionreqlists.positionreqlists') }}',
                    type: 'GET'
                },
                responsive: true,
                lengthMenu: [
