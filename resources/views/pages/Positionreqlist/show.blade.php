                                        ...
                                        <table class="table table-bordered table-striped">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{ $submission->company->name ?? '-' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>Department</th>
                                                    <td>{{ $submission->department->department_name ?? '-' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>Location</th>
                                                ...
                                                @if (!is_null($submission->approval_1))
                                                <tr>
                                                    <th>HRD Verifier</th>
                                                    <td>{{ $submission->approver1->employee_name ?? 'empty' }}</td>
                                                </tr>
                                                @endif
                                                @if (!is_null($submission->approval_2))
                                                    <tr>
                                                        <th>DIR Verifier</th>
                                                ...
                                                @endif
                                                @if (!is_null($submission->salary_hr_end))
                                                    <tr>
                                                        <th>To</th>
                                                        <td>
    ...
    <tr>
        ...
        <td>
            ...
            @if ($submission->salary_counter_end)
                &nbsp;–&nbsp;{{ number_format($submission->salary_salary_counter, 0, ',', '.') }}
            @endif
        </td>
    </tr>
@endif
