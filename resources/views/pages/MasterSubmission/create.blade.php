@extends('layouts.app')
@section('title', 'Create Master Submission')
@push('style')
        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a href="{{ route('pages.MasterSubmission') }}">Submission</a></div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0 px-3">
                                    <h6 class="mb-0">{{ __('Create Submission') }}</h6>
                                </div>
                                <div class="card-body pt-4 p-3">
                                    ...
                                    @endif
                                    <form id="position-create" action="{{ route('MasterSubmission.store') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" 
                                                            ...
                                                            placeholder="Fill Submission Name">
                                                        @error('name')
                                        ...
                                        <div class="alert alert-secondary mt-4" role="alert">
                                            <span class="text-dark">
                                                ...
                                                - If a Master Submission name is already registered, you cannot register it again.
