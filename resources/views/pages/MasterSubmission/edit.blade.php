@extends('layouts.app')
@section('title', 'Update Master Submission')
@push('style')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Update Submission {{ $leave->name }}</h1>
                <div class="section-header-breadcrumb">
                    {{-- <div class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Dashboard</a></div> --}}
                    <div class="breadcrumb-item"><a href="{{ route('pages.MasterSubmission') }}">Master Submission</a></div>
                    <div class="breadcrumb-item">Update Submission {{ $leave->name }}</div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0 px-3">
                                    <h6 class="mb-0">{{ __('Update Submission') }} {{ $leave->name }}</h6>
                                </div>
                                <div class="card-body pt-4 p-3">
                                    ...
                                    @endif
                                    <form id="position-edit" action="{{ route('MasterSubmission.update', $hashedId) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="form-control-label">
                                                        <i class="fas fa-user"></i> {{ __('Submission Name') }}
                                                    </label>
                                                    <div>
                                                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                                            name="name" value="{{ old('name', $leave->name) }}"
                                        ...
                                        <div class="d-flex justify-content-end mt-4">
                                            <a href="{{ route('pages.MasterSubmission') }}" class="btn btn-secondary">
