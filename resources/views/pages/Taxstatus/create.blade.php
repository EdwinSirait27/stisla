@extends('layouts.app')
@section('title', 'Create Tax Status')
@push('style')
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0 px-3">
                                    <h6 class="mb-0">{{ __('Create Tax Status') }}</h6>
                                </div>
                                <div class="card-body pt-4 p-3">
                                    ...
                                    <form id="tax-create" action="{{ route('Taxstatus.store') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control @error('taxstatus') is-invalid @enderror" id="taxstatus" name="taxstatus" 
                                                            value="{{ old('taxstatus') }}" required
                                                            placeholder="Fill tax status Name">
                                                        @error('taxstatus')
                                        ...
                                        <div class="alert alert-secondary mt-4" role="alert">
                                            <span class="text-dark">
                                                ...
                                                - If a tax status name is already registered, you cannot register it again.<br>
                                            </span>
                                        </div>
          ...
          document.getElementById('create-btn').addEventListener('click', function(e) {
              ...
              Swal.fire({
                  ...
                  if (result.isConfirmed) {
                      ...
                      document.getElementById('tax-create').submit();
                  }
              });
          });
    </script>
