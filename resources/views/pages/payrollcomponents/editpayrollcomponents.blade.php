@extends('layouts.app')
@section('title', 'Update Payroll Components')
        ...
        <section class="section">
                ...
                <div>
                    <div style="font-size:.72rem;color:#94a3b8;margin-bottom:3px">
                        ...
                        <a href="{{ route('payrollcomponents') }}" style="color:#64748b;text-decoration:none">Payroll
                            Components</a> /
                        <span style="color:#1e293b">Update</span>
                    </div>
                    <h1>Update Payroll Components</h1>
                </div>
            ...
            <div class="section-body">
                <div class="emp-form-card">
                    ...
                    <form action="{{ route('updatepayrollcomponents', $payrolls->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="field-grid">
                                    ...
                                    <div class="field-group">
                                        ...
                                        <input type="text" name="component_name" id="component_name"
                                            ...
                                            value="{{ old('component_name', $payrolls->component_name) }}"
                                    ...
                                    <div class="field-group">
                                        ...
                                        <select id="type" name="type"
                                            ...
                                            @foreach ($types as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ old('type', $payrolls->type) == $key ? 'selected' : '' }}>
                                                    {{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="field-group">
                                        ...
                                        <div class="d-flex align-items-center gap-2 mt-1">
                                            <input type="checkbox" name="is_fixed" id="is_fixed" value="1"
                                                {{ old('is_fixed', $payrolls->is_fixed) ? 'checked' : '' }}>
                                    ...
                                    <div class="field-group">
                                        ...
                                        <div class="d-flex align-items-center gap-2 mt-1">
                                            <input type="checkbox" name="is_employer_burden" id="is_employer_burden"
                                                value="1"
                                                {{ old('is_employer_burden', $payrolls->is_employer_burden) ? 'checked' : '' }}>
