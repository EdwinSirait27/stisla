        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Create Public Holiday</div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0 px-3">
                                    <h6 class="mb-0">{{ __('Create Public Holiday') }}</h6>
                                </div>
                                <div class="card-body pt-4 p-3">
                                    ...
                                    @endif
                                    <form id="departments-create" action="{{ route('Pubholi.store') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input
                                                            ...
                                                            value="{{ old('date') }}"
                                                            aria-describedby="info-date" required>
                                                        @error('date')
