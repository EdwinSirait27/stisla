...
<body>
    <div class="container">
        ...
        <div class="info-box">
            ...
            <p><strong>Effective Date:</strong> {{ \Carbon\Carbon::parse($announcement->publish_date)->format('d M Y') }}</p>
        ...
        <div class="info-box">
            ...
            <p><strong>Tanggal Berlaku:</strong> {{ \Carbon\Carbon::parse($announcement->publish_date)->format('d M Y') }}</p>
