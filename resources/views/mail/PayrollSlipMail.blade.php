...
<body
    style="font-family: 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #000000; margin: 0; padding: 0; background-color: #f4f6f8;">
    <div
        style="max-width: 700px; margin: 20px auto; background: #fff; border: 1px solid #e1e1e1; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 25px 30px; border-bottom: 2px dashed #ddd;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin: 25px 0; font-size: 14px;">
                ...
                <tr>
                    ...
                    <td style="border: 1px solid #e1e1e1; padding: 12px;">PDF Detail</td>
                </tr>
                <tr>
            ...
            <p><strong>Note:</strong> To open the attached PDF file, please use the password below:</p>
            <p style="text-align: center; margin: 15px 0;">
                <span
                    style="display: inline-block; font-size: 18px; font-weight: bold; letter-spacing: 3px; background-color: #f0f0f0; color: #004085; padding: 8px 20px; border-radius: 6px; border: 1px dashed #004085;">
                    {{ $slipPassword }}
                </span>
            </p>
            <p style="font-size: 13px; color: #666;">Please keep this password confidential. Do not share it with
                anyone.</p>
        ...
        <div style="padding: 25px 30px;">
            ...
            <p><strong>Catatan:</strong> Untuk membuka file PDF terlampir, gunakan password berikut:</p>
            <p style="text-align: center; margin: 15px 0;">
                <span
                    style="display: inline-block; font-size: 18px; font-weight: bold; letter-spacing: 3px; background-color: #f0f0f0; color: #004085; padding: 8px 20px; border-radius: 6px; border: 1px dashed #004085;">
                    {{ $slipPassword }}
            ...
            <p style="font-size: 13px; color: #666;">Mohon jaga kerahasiaan password ini. Jangan bagikan kepada
                siapapun.</p>
        ...
        <div
            style="background-color: #f8f9fa; padding: 15px; text-align: center; font-size: 12px; color: #555; border-top: 1px solid #e1e1e1;">
            <p style="margin: 5px 0;">This is an automated email. Please do not reply.</p>
            <p style="margin: 5px 0;">Mark important for the sender of this email to get the pay slip notification for
                the next month.</p>
            <p style="margin: 5px 0;">&copy; {{ date('Y') }} {{ $companyName }} — Developed by Edwin Sirait</p>
        </div>
    </div>
</body>
