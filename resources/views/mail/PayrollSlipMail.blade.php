...
<body style="font-family: 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #000000; margin: 0; padding: 0; background-color: #f4f6f8;">
    <div style="max-width: 700px; margin: 20px auto; background: #fff; border: 1px solid #e1e1e1; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 25px 30px; border-bottom: 2px dashed #ddd;">
            ...
            <p><strong>Note:</strong> To open the PDF file, please use your date of birth registered in the HR System in the format
    ...
    <div style="max-width: 700px; margin: 20px auto; background: #fff; border: 1px solid #e1e1e1; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 25px 30px; border-bottom: 2px dashed #ddd;">
            ...
            <p style="text-align: center; margin: 15px 0;">
                <span style="display: inline-block; font-size: 18px; font-weight: bold; letter-spacing: 3px; background-color: #f0f0f0; color: #004085; padding: 8px 20px; border-radius: 6px; border: 1px dashed #004085;">
                    {{ $slipPassword }}
                </span>
            </p>
            <p style="font-size: 13px; color: #666;">Please keep this password confidential. Do not share it with anyone.</p>
        ...
        <div style="padding: 25px 30px;">
            ...
            <p style="font-size: 13px; color: #666;">Mohon jaga kerahasiaan password ini. Jangan bagikan kepada siapapun.</p>
