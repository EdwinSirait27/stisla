...
<div class="container">
    <h1>403</h1>
    <p class="page-description">Session Expired.</p>
...
<body>
    ...
    <main>
        <div class="code">419 — Expired Session</div>
        <h1>Page <em>session</em><br>expired.</h1>
        <p>Refresh page,then back to login.</p>
        <div class="actions">
             @auth
            <form method="POST" action="{{ route('logout') }}">
                @csrf
