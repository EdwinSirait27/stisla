...
<div class="container">
    <h1>503</h1>
    <p class="page-description"> Be right back Okayyy :)...</p>
...
<body>
    ...
    <main>
        <div class="code">503 — Server sakit</div>
        <h1>Server <em>lagi</em><br>maintenance.</h1>
        <p>kita rehat sejenak:).</p>
        <div class="actions">
             @auth
            <form method="POST" action="{{ route('logout') }}">
                @csrf
