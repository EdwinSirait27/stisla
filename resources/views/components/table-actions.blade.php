                                    ...
                                    <table class="table table-hover table-striped" id="users-table">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center th-name">NIP</th>
...
@push('scripts')
    ...
    {{-- === Init Default Date (Awal & Akhir Bulan) === --}}
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const today = new Date();
            const year = today.getFullYear();
        ...
        $(document).ready(function() {
            ...
            const table = $('#users-table').DataTable({
                ...
                rowCallback: function(row, data) {
                    if (data.is_edited == 1) $(row).css('background-color', '#cce5ff');
                },
            ...
            $('#resetBtn').on('click', () => {
                $('#startDate, #endDate, #store_name').val('');
                table.ajax.reload();
            });
            ...
            setInterval(() => {
                ...
                if (!isSearching) table.ajax.reload(null, false);
            }, 100000);
    ...
    <script>
        ...
        // Jika sidebar pakai toggle (contoh di Stisla)
        $('.main-sidebar, .nav-link.toggle-sidebar, #sidebarToggle').on('click', function() {
            setTimeout(adjustTable, 400); // tunggu animasi sidebar selesai
        });
    </script>
@endpush
