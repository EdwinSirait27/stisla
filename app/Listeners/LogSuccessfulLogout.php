...
class LogSuccessfulLogout
{
    ...
    // protected function getAllMacAddresses()
    // {
    //     // Implementasi sama seperti di listener login
    //     $macAddresses = [];
    ...
    //     if (preg_match_all('/([0-9A-Fa-f]{2}[:-]){5}([0-9A-Fa-f]{2})/', $arpOutput, $matches)) {
    //         $macAddresses['wifi'] = strtoupper($matches[0][0] ?? '');
    //     }
